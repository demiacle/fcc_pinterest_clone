...
class App extends Component {
  ...
  logout(e) {
    ...
    fetch("/logout", { credentials: "include" }).catch(err =>
      alert("You encountered an error while logging out.")
    );
  }
    ...
    var childElements = elements.map((i, index) => {
      return (
        <Post
          ...
          removeFromWall={this.removeFromWall}
  ...
  addPost(post) {
    ...
    window.location.replace(
      "https://fcc-pinterest-clone-demiacle.herokuapp.com/"
    );
    this.forceUpdate();
    setTimeout(() => {
      ...
      <div className="App">
        ...
        <header className="App-header">
          <h1 className="App-title">
            ...
            PICPAC
            <div className="spin" />
            {this.state.showUploadingForm && (
              <UploadForm addPost={this.addPost} />
            )}
          </h1>
        </header>
        ...
        <div id="theWall">
          <p id="builtBy">
            Built by <a href="https://demiacle.github.io/">Daniel Escobedo</a>:<a href="https://twitter.com/Demiacle">
              @Demiacle
            </a>{" "}
            using React, Express and masonry.js
          </p>
